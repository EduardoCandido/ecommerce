...
class Cart extends Model {
    ...
    public function getProducts(){//pega os produtos no carrinho
        $sql = new Sql();
    ...
    public function getProductsTotals()//Pega os produtos em um carrinho e seus valores para o calculo do frete
    {
        $sql = new Sql();
    ...
    public function setFreight($nrzipcode)//Calcula o frete
    {
